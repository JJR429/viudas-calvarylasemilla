<template>
  <div class="dashboard">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-4 mb-5">
              ...
              <p class="page-header-text">
                <span
                  class="text-white px-2 py-2 rounded bg-green"
                  v-if="viuda.estado == 1"
                  ><i class="fas fa-exclamation-triangle"></i> ACTIVO</span
                >
                <span
                  class="text-dark px-2 py-2 rounded bg-yellow"
                  v-if="viuda.estado == 0"
                  ><i class="fas fa-exclamation-triangle"></i> OBSERVADO</span
                >
                <span
                  class="text-danger px-2 py-2 rounded bg-danger-soft"
                  v-if="viuda.estado == 2"
                  ><i class="fas fa-exclamation-triangle"></i> EN PAPELERA</span
                >
              </p>
              <hr />
              ...
              <div class="row">
                <div class="col-md-6 text-left">
                  ...
                  <div>
                    <ul class="text-left list-unstyled">
                      <li>
                        ¿Tiene trabajo?:
                        <b>{{ viuda.tiene_trabajo == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        ¿Trabajo remunerado?:
                        <b>{{ viuda.trabajo_remunerado == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        ¿Tiene Pensión 65?:
                        <b>{{ viuda.pension_65 == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        ¿Tiene Seguro?:
                        <b>{{ viuda.tiene_seguro == 1 ? "SI" : "NO" }}</b>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <ul class="text-left list-unstyled">
                      <li>
                        ¿Tiene discapacidad?
                        <b>{{ viuda.tiene_discapacidad == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        Discapacidad: <b>{{ viuda.discapacidad }}</b>
                      </li>
                      <li>
                        ¿Toma medicamentos?:
                        <b>{{ viuda.toma_medicamentos == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        Descricpión de los medicamentos:
                        <b>{{ viuda.descripcion_medicamentos }}</b>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <ul class="text-left list-unstyled">
                      <li>
                        Viuda desde: <b>{{ viuda.viuda_desde }}</b>
                      </li>
                      <li>
                        Nombre pareja: <b>{{ viuda.nombre_pareja }}</b>
                      </li>
                    </ul>
                  </div>
                </div>
                <div class="col-md-6 text-left">
                  ...
                  <div>
                    <ul class="text-left list-unstyled">
                      <li>
                        Religión: <b>{{ viuda.religion }}</b>
                      </li>
                      <li>
                        ¿Sabe de Dios?:
                        <b>{{ viuda.sabe_de_dios == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        Conoce de Dios?:
                        <b>{{ viuda.conoce_de_dios == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        ¿Relación con Jesus?:
                        <b>{{ viuda.relacion_con_jesus == 1 ? "SI" : "NO" }}</b>
                      </li>
                      <li>
                        Fecha que acepto Jesus:
                        <b>{{ viuda.fecha_de_aceptacion }}</b>
                      </li>
                      <li>
                        ¿Asiste a una iglesia?:
                        <b>{{
                          viuda.asiste_a_una_iglesia == 1 ? "SI" : "NO"
                        }}</b>
                      </li>
                      <li>
                        Iglesia: <b>{{ viuda.iglesia }}</b>
                      </li>
                      <li>
                        ¿Desde que fecha asiste?:
                        <b>{{ viuda.desde_que_fecha }}</b>
                      </li>
                      <li>
                        ¿Le interesa Jesus?:
                        <b>{{ viuda.le_interesa_jesus == 1 ? "SI" : "NO" }}</b>
                      </li>
                    </ul>
                  </div>
                              ...
                              <div class="mr-4 d-flex">
                                <div>
                                  ...
                                  <p class="card-text">
                                    Sexo:
                                    <b>{{
                                      hijo.sexo == 0 ? "FEMENINO" : "MASCULINO"
                                    }}</b
                                    ><br />
                                    ¿Con Discapacidad?
                                    <b>{{
                                      hijo.tiene_discapacidad == 1 ? "SI" : "NO"
                                    }}</b
                                    ><br />
                                    <span v-if="hijo.tiene_discapacidad == 1"
                                      >Descripción:
                                      {{ hijo.discapacidad }}</span
                                    >
                                  </p>
                                </div>
                              </div>
                ...
                <div class="col-md-12 mt-5 text-left ">
                  ...
                  <button
                    ...
                    ref="btnUpdateHijo"
                  >
                    Editar <i class="fas fa-file-pdf"></i>
                  </button>
                  <button class="btn btn-dark mx-2" onclick="window.print()">
                    Imprimir <i class="fas fa-file-pdf"></i>
                  </button>
                  <hr />
                  <h4 class="mt-2">
                    ¿Quieres más opciones de estado (observar, eliminar)?
                  </h4>
                  <router-link
                    :to="{
                      name: 'viudas'
                    ...
                    class="btn btn-primary rounded-pill"
                    ><i class="fas fa-arrow-left"></i> Regresar y
                    editar</router-link
                  >
                </div>
              </div>
      ...
      <template v-slot:default="">
        ...
        <div class="form-row">
          <div class="form-group col-md-6 text-left pl-0">
            <b-form-group
              label="¿Vive con la Viuda?"
              class="small text-gray-600"
            >
              <div class="d-flex">
                <b-form-radio
                  class="mr-2"
                  v-model="hijoToSave.vive_con_viuda"
                  name="radio_vive_con_viuda"
                  value="1"
                  >SI</b-form-radio
                >
                <b-form-radio
          ...
          <div class="form-group col-md-6 text-left">
            ...
            >
              <div class="d-flex">
                <b-form-radio
                  class="mr-2"
                  v-model="hijoToSave.tiene_discapacidad"
          ...
          <div class="form-group col-md-12 text-left">
            ...
            <input
              :disabled="
                hijoToSave.tiene_discapacidad == 0 ||
                  hijoToSave.tiene_discapacidad == null
              "
      ...
      <template v-slot:default="">
          ...
          <div class="form-group col-md-6 text-left">
            <b-form-group label="Sexo" class="small text-gray-600">
              <div class="d-flex">
                <b-form-radio
                  class="mr-2"
                  v-model="hijoToUpdate.sexo"
                  name="update_radio_sexo"
                  value="0"
                  >FEMENINO</b-form-radio
                >
                <b-form-radio
        ...
        <div class="form-row">
          <div class="form-group col-md-6 text-left">
            ...
            >
              <div class="d-flex">
                <b-form-radio
                  class="mr-2"
                  v-model="hijoToUpdate.vive_con_viuda"
                  name="update_radio_vive_con_viuda"
                  value="1"
                  >SI</b-form-radio
                >
                <b-form-radio
          ...
          <div class="form-group col-md-6 text-left pl-0">
            ...
            >
              <div class="d-flex">
                <b-form-radio
                  class="mr-2"
                  v-model="hijoToUpdate.tiene_discapacidad"
          ...
          <div class="form-group col-md-12 text-left">
            ...
            <input
              :disabled="
                hijoToUpdate.tiene_discapacidad == 0 ||
                  hijoToUpdate.tiene_discapacidad == null
              "
    ...
    <b-modal id="modalDeleteHijo" centered>
      ...
      <template v-slot:default="">
        ...
        <span class="text-danger"
          >Esta acción eliminara por completo los datos de la persona del
          sistema.</span
        >
      </template>
      <template v-slot:modal-footer="{ ok, cancel }">
    ...
    <b-modal id="modalDeleteVisita" centered>
      <template v-slot:modal-header="">
        <h3 class="modal-title">
          Estás a punto de eliminar la Visita Nro
          {{ visitaToDelete.index + 1 }} con Fecha
          {{ visitaToDelete.fecha_visita }}
        </h3>
      </template>
      <template v-slot:default="">
        ...
        <div class="form-row">
          <div class="form-group col-md-6 text-left">
            <label class="small text-gray-600" for="leadCapFirstName"
              >DNI</label
            >
            <input v-model="ToUpdate.dni" class="form-control" type="number" />
          </div>
          <div class="form-group col-md-6 text-left">
            <label class="small text-gray-600" for="leadCapFirstName"
              >Fecha Nacimiento</label
        ...
        <div class="form-row">
          <div class="form-group col-md-6 text-left">
            <label class="small text-gray-600" for="leadCapFirstName"
              >Región</label
            >
            <input v-model="ToUpdate.region" class="form-control" type="text" />
          </div>
          <div class="form-group col-md-6 text-left">
            <label class="small text-gray-600" for="leadCapFirstName"
              >Ciudad</label
            >
            <input v-model="ToUpdate.ciudad" class="form-control" type="text" />
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-6 text-left">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-12 text-left">
            <label class="small text-gray-600" for="leadCapFirstName"
              >Observaciones</label
            >
            <textarea v-model="ToUpdate.observaciones" class="form-control" />
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    openModalUpdateHijo: function(_index) {
      ...
      this.hijoToUpdate.fecha_nacimiento = this.viuda.hijos[
        _index
      ].fecha_nacimiento;
      this.hijoToUpdate.sexo = this.viuda.hijos[_index].sexo;
      this.hijoToUpdate.vive_con_viuda = this.viuda.hijos[
        _index
      ].vive_con_viuda;
      this.hijoToUpdate.tiene_discapacidad = this.viuda.hijos[
        _index
      ].tiene_discapacidad;
    ...
    openModalUpdateVisita: function(_index) {
      ...
      this.visitaToUpdate.fecha_visita = this.viuda.visitas[
        _index
      ].fecha_visita;
    ...
    openModalDeleteVisita: function(_index) {
      ...
      this.visitaToDelete.fecha_visita = this.viuda.visitas[
        _index
      ].fecha_visita;
